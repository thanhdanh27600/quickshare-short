	...
	return (
		...
		>
			<div
				...
				className="pointer-events-none relative flex min-h-full w-auto translate-y-[-50px] items-center opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto max-[576px]:mt-12 min-[576px]:min-h-full min-[576px]:max-w-[500px]"
			>
